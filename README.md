...
You can set 1 or more ip addresses domains and lists included (RHOST/RHOSTS), the number of packets you want to send (COUNT), also the waiting time for a response (TIMEOUT), the number of process (THREADS) and the payload (MESSAGE) too.
